...
import com.system.dao.DaoUtil;
import com.system.dao.ISuperBaseDao;
...
public abstract class SuperBaseDao<T> implements ISuperBaseDao<T> {  
    private Class<T> clazz;  
    @Resource(name = "sessionFactory")  
    protected SessionFactory sessionFactory;  
    protected static Logger logger = Logger.getLogger(SuperBaseDao.class);  
