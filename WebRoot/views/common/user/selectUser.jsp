...
<html>
  ...
  <body>
    <form action="" id="searchForm" >
    		<input type="hidden" name="returnUrl" value="/common/user/selectUserList"/>
	   		<input type="hidden" name="currentPage" value="${currentPage==null?1:currentPage}"/>
		   <input type="text"  id="username" name="username" size="15px"  style="margin-left:50%;" placeholder="请输入员工名">
