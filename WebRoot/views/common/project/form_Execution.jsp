...
<div>
	<form action="" name="executionForm" id="formId"> 
	<div id="page1">
		...
		<input type="text"  class="application-form form2"  id="project_Execution.totalExpenditure" name="project_Execution.totalExpenditure" placeholder="支出合计">
		<input type="text"  class="application-form form2"  id="project_Execution.innovationType" name="project_Execution.innovationType" placeholder="创新类型">
	...
	<div id="page4" style="display:none;">
		<textarea  class="application-form form3"  id="project_Execution.capitalPosition" name="project_Execution.capitalPosition" placeholder="项目计划投资到位情况"></textarea>
		<textarea  class="application-form form3"  id="project_Execution.workload" name="project_Execution.workload" placeholder="项目参加人员投入工作量"></textarea>
	</div>
	<div id="page5" style="display:none;">
		<textarea  class="application-form form3"  id="project_Execution.tecSources" name="project_Execution.tecSources" placeholder="项目技术来源"></textarea>
	...
	<div id="page7" style="display:none;">
		<textarea  class="application-form form6"  id="project_Execution.exeCondition" name="project_Execution.exeCondition" placeholder="本年度项目执行情况"></textarea>
...
//添加验证信息
$("#formId").ajaxSubmit({
	url:'${base}/ord/addExecutionProject?status='+status,
	type:'post',
