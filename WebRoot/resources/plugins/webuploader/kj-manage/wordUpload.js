 ...
 * @param submitFunc	上传成功后调用的方法
 * @returns	uploaer对象
 */
function word_createUploader(url, propertyName, listName, pickerName, submitFunc){ 
   /*init webuploader*/  
   ...
   uploader.on("error",function (type){
       if (type=="Q_TYPE_DENIED"){
    	   layer.alert("请上传word文件(doc、docx)", {icon: 2,title:"Error"});
